...
class _HomePageState extends State<HomePage> {
  ...
  List categories = ["Maki", "Nigiri", "Gunkan", "Temaki"];
  int tabIndex = 0;
  @override
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: index==tabIndex?Border.all(color: Color.fromARGB(255, 252, 189, 189),width:2):Border.all(color:Colors.transparent),
                            ),
